...
?></div>
    ...
    <div class="card">
        <h1 class="title"><span>Здравје и живот</span>Login <span class="msg">Најави се за да започне сесијата</span></h1>
        <div class="col-md-12">
    ...
    <div class="input-group"> <span class="input-group-addon"> <i class="zmdi zmdi-account"></i> </span>
                ...
                <div>
					...
					<input type="submit" name="submit" id="submit" value="Најави ме" class="btn btn-raised waves-effect g-bg-cyan" /></div>
