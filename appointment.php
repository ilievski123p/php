...
if(isset($_POST[submit]))
{
  if(isset($_GET[editid]))
  {
   ...
   {
    echo "<script>alert('Извештајот за термин е ажуриран успешно..');</script>";
}
else
{
                                    ...
                                    <div class="form-line">
                                      ...
                                      else
                                      {
                                        ...
                                        <select name="select4" id="select4" class=" form-control show-tick">
                                            <option value="">Одбери пациент</option>
                                            <?php
                                ...
                                <div class="form-group">
                                    <div class="form-line">
                                        <select name="select6" id="select6" class=" form-control show-tick">
                                            <option value="">Одбери доктор</option>
                                            <?php
                            ...
                            <div class="col-sm-4 ">
                                <div class="form-group drop-custum">
                                    <select name="select" id="select" class=" form-control show-tick">
                                        ...
                                        <option value="">Одбери статус</option>
                                        <?php
