...
--
-- Host: localhost
-- Generation Time: Jun 15, 2019 at 08:53 PM
...
(1, 'Petar Ilievski', 'admin', '123456789', 'Active', '');
...
(1, 2, 1, 'Цена за консултација', 45.00, '2019-06-15', 'Active'),
(2, 2, 20, 'Третман', 300.00, '2019-06-15', 'Active'),
(3, 2, 1, 'Цена на рецепта', 45.00, '2019-06-15', 'Active');
...
(1, 'Eleonora Moneva', '078458965', 1, 'doctor', '123456789', 'Active', 'MBBS', 7.0, 800.00);
...
(1, 'Paracetamol', 3.00, 'За настинка, едно на ден', 'Active');
...
(1, 'Petar', '2019-06-15', '18:47:22', 'Savevski', '0789563256', 'Rudari', '1207', 'patient', '123456789', 'O+', 'MALE', '1990-01-01', 'Active');
...
(15, 'Општа Соба', 1, 20, 500.00, 'Active'),
(16,  'Општа Соба', 2, 10, 100.00, 'Active'),
(17,  'Општа Соба', 2, 10, 500.00, 'Active'),
(18,  'Општа Соба', 121, 13, 150.00, 'Active'),
(19, 'Операциона сала', 850, 11, 500.00, 'Active');
