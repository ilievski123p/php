...
if(isset($_POST[submit]))
{
	if(isset($_GET[editid]))
	{
		...
		{
			echo "<script>alert('Извештај за лекот е ажуриран успешно...');</script>";
		}
		else
		{
	...
	else
	{
		...
		if($qsql = mysqli_query($con,$sql))
		{
			echo "<script>alert('Лекот е вметнат успешно...');</script>";
		}
		else
		{
			echo mysqli_error($con);
...
<div class="container-fluid">
	<div class="block-header">
            <h2>Додај нов извештај за лек</h2>
