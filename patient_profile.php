...
<body>
	...
	<aside class="sidebar-left" style="width: 200px;">
		...
		<a class="company-logo" href="#">Лого</a>

		<div class="sidebar-links">
			<a class="link-blue" href="javascript:patient_pg(1,<?=$pid?>);"><i class="fa fa-keyboard-o"></i>Додај преглед</a>
			<a class="link-red" href="viewappointment.php"><i class="fa fa-keyboard-o"></i>Погледни закажани прегледи</a>
			<a class="link-yellow selected" href="patient_profile.php"><i class="fa fa-keyboard-o"></i>Погледни профил</a>
			<a class="link-green" href="logout.php"><i class="fa fa-map-marker"></i>Одјави ме</a>
		</div>
	...
	<div class="main-content">
		...
		<div class="container" style="width: 918px; margin-top: -121px;">
			...
			<div class="heading">
				<h2>Ве молиме внесете детали за пациентот</h2>
				<p>Пополнете ја формата и ве молиме поднесете ја побрзу.</p>
			</div>
			...
			<div class="agile-form">
				...
				<div class="row">
                    ...
                    <label class="form-label" style="align:left;"> Целосно име
                    ...
                    <label class="form-label" style="align:left;"> Емаил
								<span class="form-required" > * </span>
						</label>
				...
				<div class="col-md-12">
                    ...
                    <label class="form-label" style="align:left;"> Адреса
								<span class="form-required"> * </span>
						</label>
...
<div class="copyright">
		<p>© 2021 <a href="www.w3layouts.com">W3layouts</a></p> 
	</div>
