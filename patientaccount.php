...
<div class=" container-fluid">
    <div class="block-header">
        <h2>Dashboard</h2>
        <small class="text-muted">Добредојдовте во нашата болница</small>
    </div>
                ...
                <div class="card">
                    <div class="header">
                        <div class="alert bg-teal">
                            <h3>Добредојдовте , <?php echo $rspatient[patientname]; ?> !! </h3>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-12 col-md-12 col-lg-12">
                ...
                <ul class="nav nav-tabs">
                    <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#home_animation_1"
                            aria-expanded="true">Историја на регистрирање</a></li>
                    <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#profile_animation_1"
                            aria-expanded="false">Термин</a></li>
                ...
                <div class="tab-content" style="padding: 10px">
                    <div role="tabpanel" class="tab-pane animated flipInX active" id="home_animation_1"
                        aria-expanded="true"> <b>Историја на регистрирање</b>
                        <h3>Вие сте со нас од  <?php echo $rspatient[admissiondate]; ?>
                            <?php echo $rspatient[admissiontime]; ?></h3>
                    </div>
                    <div role="tabpanel" class="tab-pane animated flipInX" id="profile_animation_1"
                        aria-expanded="false"> <b>Термин</b>
                        <?php
                        if(mysqli_num_rows($qsqlpatientappointment) == 0)
                        {
                            ?>
                        <h3>Податоците за термини не се пронајдени.. </h3>
                        <?php
                        }
                        else
                        {
                            ?>
                        <h3>Последен преглед е од - <?php echo $rspatientappointment[appointmentdate]; ?>
