...
if(isset($_POST[submit]))
{
		if(isset($_GET[editid]))
		{
			...
			{
				echo "<script>alert('Терминот е ажуриран успешно...');</script>";
			}
			else
			{
...
<div class="toggle">
	<!-- Toggle Link -->
	<a href="#" title="Title of Toggle" class="toggle-trigger">Профил на пациент</a>
...
<div class="toggle">
	<!-- Toggle Link -->
	<a href="#" title="Title of Toggle" class="toggle-trigger">Извештај за термин</a>
	<!-- Toggle Content to display -->
	<div class="toggle-content">
...
<div class="toggle">
	<!-- Toggle Link -->
	<a href="#" title="Title of Toggle" class="toggle-trigger">Извештај за лекување</a>
	<!-- Toggle Content to display -->
	<div class="toggle-content">
...
<div class="toggle">
	<!-- Toggle Link -->
	<a href="#" title="Title of Toggle" class="toggle-trigger">Извештај за лекови</a>
	<!-- Toggle Content to display -->
	<div class="toggle-content">
		<p><?php
...
<div class="toggle">
	<!-- Toggle Link -->
	<a href="#" title="Title of Toggle" class="toggle-trigger">Извештај за наплата</a>
	<!-- Toggle Content to display -->
	<div class="toggle-content">
		<p><?php
...
?>
    ...
    <div class="toggle">
        <!-- Toggle Link -->
        <a href="#" title="Title of Toggle" class="toggle-trigger">Извештај за плаќање</a>
        <!-- Toggle Content to display -->
        <div class="toggle-content">
            <p><?php
            $billappointmentid= $rsappointment[0]; 
	...
	$rsbilling_records = mysqli_fetch_array($qsqlbilling_records);
				  ...
				  <a class="btn btn-raised" href="paymentdischarge.php?appointmentid=<?php echo $rsappointment[0]; ?>&patientid=<?php echo $_GET[patientid]; ?>">Направи наплата</a>
