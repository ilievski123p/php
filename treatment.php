...
if(isset($_POST[submit]))
{
	if(isset($_GET[editid]))
	{
		...
		{
			echo "<script>alert('Лекувањето е успешно ажурирано..');</script>";
		}
		else
		{
		...
		<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
			<div class="card">
				...
				<form method="post" action="" name="frmtreat" onSubmit="return validateform()">
					<div class="row">
						<div class="col-sm-4 col-xs-12">
							<div class="form-group">
								<label for="type">Тип на третман</label>
								<div class="form-line">
						...
						<div class="col-sm-4 col-xs-12">
							<div class="form-group">
								<label for="type">Цена на третман</label>
								<div class="form-line">
					...
					<div class="col-sm-12">
						<input type="submit" name="submit" id="submit" value="Потврди" class="btn btn-raised" />
					</div>
