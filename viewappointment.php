...
if(isset($_GET[approveid]))
{
	...
	if(mysqli_affected_rows($con) == 1)
	{
		echo "<script>alert('Терминот е успешно одобрен.');</script>";
	}
}
?>
<div class="container-fluid">
  <div class="block-header">
    <h2>Погледни извештаи за термини</h2>
    ...
    <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
      ...
      <thead>
        <tr>
          ...
          <th>Причина</th>
          <th>Статус</th>
          <th><div align="center">Акција</div></th>
        </tr>
        </thead>
        <tbody>
          <?php
        ...
        echo "<tr>
		  ...
		  if($rs[status] != "Approved")
		  {
				  if(!(isset($_SESSION[patientid])))
				  {
						  echo "<a href='appointmentapproval.php?editid=$rs[appointmentid]'>Одобри</a><hr>";
				  }
				 echo "  <a href='viewappointment.php?delid=$rs[appointmentid]'>Delete</a>";
		  }
		  else
		  {
				echo "<a href='patientreport.php?patientid=$rs[patientid]&appointmentid=$rs[appointmentid]'>Прегледај извештај</a>";
		  }
		 echo "</center></td></tr>";
		}
		?>
