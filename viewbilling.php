...
if(isset($_GET[delid]))
{
	...
	{
		echo "<script>alert('Сметката е успешно избришана..');</script>";
	}
}
?>
...
?>
 	<table class="table table-bordered table-striped">
      <tbody>
        ...
        <tr>
          <th width="124" scope="col"><div align="right">Број на термини &nbsp; </div></th>
          	<td width="413"> <?php echo $rsbilling_records[appointmentid]; ?>
            </td>
        </tr>
         
		<tr>
		  <th scope="col"><div align="right">Датум на сметка &nbsp; </div></th>
		  <td>&nbsp;<?php echo $rsbilling_records[billingdate]; ?></td>
	    </tr>
        
		<tr>
		  <th scope="col"><div align="right">Време на сметка &nbsp; </div></th>
	...
	<table class="table table-bordered table-striped">
      <thead>
       <tr>
          <th width="97" scope="col">Датум</th>
          <th width="245" scope="col">Опис</th>
          <th width="86" scope="col">Износ на сметка</th>
        </tr>
        </thead>
        <tbody>
         <?php
...
if($rs[bill_type]  == "Prescription charge")
{
    ...
    <table class="table table-bordered table-striped">
      <tbody>
        <tr>
          <th scope="col"><div align="right">Износ н сметка &nbsp; </div></th>
          <td>&nbsp;Tk. <?php echo $billamt; ?></td>
        </tr>
        <tr>
          <th width="442" scope="col"><div align="right">Износ на ДДВ (5%) &nbsp; </div></th>
